...
test.describe("Test Group", () => {
  ...
  test("Check() checks the radio buttons and checkboxes if they havnt been checked yet", async ({
    page,
  }) => {
  ...
  test("unchecked() unchecks the radio buttons and checkboxes if they havnt been unchecked yet", async ({
    page,
  }) => {
    let checkboxesLink = page.locator("text='Checkboxes'");
    await checkboxesLink.click();
